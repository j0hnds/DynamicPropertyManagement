...
namespace CronUtils
{
    ...
    [TestFixture]
    public class TestDayCronValueCreator
    {
        ...
        private const string INVALID_LOWER_RANGE = "33-18";
        private const string INVALID_UPPER_RANGE = "23-42";
        ...
        public void SetUp()
        {
            cut = CronValueFactory.GetDayCreator();
        }
        ...
        [Test]
        public void TestGetDayWildcardCreator()
        {
        ...
        [Test]
        public void TestGetDaySingleValueCreator()
        {
        ...
        [Test]
        public void TestGetDayRangeCreator()
        {
        ...
        [Test]
        public void TestGetDayStepCreator()
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                if (i % STEP != 0)
                {
                    Assert.IsFalse(cv.IsEffective(i), "Value {0} should not have been effective", i);
                }
            }
        }
